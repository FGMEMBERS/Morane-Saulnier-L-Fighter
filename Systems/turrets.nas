...
var turret=
{
	...
	limit: func(value, min, max, lastValue)
	{
	  ...
	  #creation de l'objet
          var observerturret = turret.new("observerturret",0,9,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch",0,0,60,0,70,60);
	...
	#    tourelledetoit.init();
        ...
        #la gestion des tir n'a pas encore ate faite		
